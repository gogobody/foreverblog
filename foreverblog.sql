...
-- ----------------------------
BEGIN;
INSERT INTO `admin_menu` VALUES (1, 0, 1, '仪表盘', 'fa-bar-chart', '/', NULL, NULL, '2019-11-25 17:00:37');
INSERT INTO `admin_menu` VALUES (2, 0, 10, '权限管理', 'fa-tasks', NULL, NULL, NULL, '2019-12-13 08:40:42');
INSERT INTO `admin_menu` VALUES (3, 2, 11, '管理员', 'fa-users', 'auth/users', NULL, NULL, '2019-12-13 08:40:42');
INSERT INTO `admin_menu` VALUES (4, 2, 12, '角色', 'fa-user', 'auth/roles', NULL, NULL, '2019-12-13 08:40:42');
INSERT INTO `admin_menu` VALUES (5, 2, 13, '权限', 'fa-ban', 'auth/permissions', NULL, NULL, '2019-12-13 08:40:42');
INSERT INTO `admin_menu` VALUES (6, 2, 14, '菜单', 'fa-bars', 'auth/menu', NULL, NULL, '2019-12-13 08:40:42');
INSERT INTO `admin_menu` VALUES (7, 2, 15, '操作日志', 'fa-history', 'auth/logs', NULL, NULL, '2019-12-13 08:40:42');
INSERT INTO `admin_menu` VALUES (8, 0, 4, '博客管理', 'fa-bars', 'blogs', NULL, '2019-11-25 19:00:06', '2019-12-06 14:52:37');
INSERT INTO `admin_menu` VALUES (9, 0, 3, '文章管理', 'fa-file-text-o', 'articles', NULL, '2019-11-25 23:45:26', '2019-12-06 14:52:37');
INSERT INTO `admin_menu` VALUES (10, 0, 6, '大事记管理', 'fa-list-alt', 'datelines', NULL, '2019-11-26 04:05:54', '2019-12-06 14:52:37');
INSERT INTO `admin_menu` VALUES (11, 0, 5, '评论管理', 'fa-comments-o', 'comments', NULL, '2019-11-26 05:16:05', '2019-11-26 05:16:10');
INSERT INTO `admin_menu` VALUES (12, 0, 9, '系统设置', 'fa-cog', 'settings', NULL, '2019-11-26 18:47:43', '2019-12-13 08:40:42');
INSERT INTO `admin_menu` VALUES (13, 0, 7, '页面管理', 'fa-pagelines', 'pages', NULL, '2019-11-30 08:38:00', '2019-12-06 14:52:37');
INSERT INTO `admin_menu` VALUES (14, 0, 2, '公告管理', 'fa-align-justify', 'notices', NULL, '2019-12-06 14:52:08', '2019-12-06 14:52:37');
INSERT INTO `admin_menu` VALUES (15, 0, 8, '手动检测', 'fa-calendar-check-o', 'check', NULL, '2019-12-13 08:40:31', '2019-12-13 08:40:42');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `admin_permissions` VALUES (1, '所有权限', '*', '', '*', NULL, '2019-12-10 10:01:54');
INSERT INTO `admin_permissions` VALUES (2, '仪表盘', 'dashboard', 'GET', '/', NULL, '2019-12-10 10:01:05');
INSERT INTO `admin_permissions` VALUES (3, '登录', 'auth.login', '', '/auth/login\r\n/auth/logout', NULL, '2019-12-10 10:01:18');
INSERT INTO `admin_permissions` VALUES (4, '管理员设置', 'auth.setting', 'GET,PUT', '/auth/setting', NULL, '2019-12-10 10:01:31');
INSERT INTO `admin_permissions` VALUES (5, '权限管理', 'auth.management', '', '/auth/roles\r\n/auth/permissions\r\n/auth/menu\r\n/auth/logs', NULL, '2019-12-10 10:01:43');
INSERT INTO `admin_permissions` VALUES (6, '公告管理', 'notices', '', '/notices*', '2019-12-10 09:39:04', '2019-12-10 09:50:02');
INSERT INTO `admin_permissions` VALUES (7, '文章管理', 'articles', '', '/articles*', '2019-12-10 09:50:35', '2019-12-10 09:50:35');
INSERT INTO `admin_permissions` VALUES (8, '博客管理', 'blogs', '', '/blogs*', '2019-12-10 09:51:01', '2019-12-10 09:51:01');
INSERT INTO `admin_permissions` VALUES (9, '评论管理', 'comments', '', '/comments*', '2019-12-10 09:51:18', '2019-12-10 09:51:18');
INSERT INTO `admin_permissions` VALUES (10, '大事记管理', 'datelines', '', '/datelines*', '2019-12-10 09:51:35', '2019-12-10 09:51:35');
INSERT INTO `admin_permissions` VALUES (11, '页面管理', 'pages', '', '/pages*', '2019-12-10 09:51:54', '2019-12-10 09:51:54');
INSERT INTO `admin_permissions` VALUES (12, '系统设置', 'settings', '', '/settings*', '2019-12-10 10:02:51', '2019-12-10 10:02:59');
INSERT INTO `admin_permissions` VALUES (13, '手动检测', 'check', '', '/check*', '2020-04-26 08:54:52', '2020-04-26 08:55:00');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `admin_roles` VALUES (1, 'Administrator', 'administrator', '2019-11-25 00:06:57', '2019-11-25 00:06:57');
INSERT INTO `admin_roles` VALUES (3, 'Admin', 'admin', '2019-12-10 09:43:26', '2019-12-10 09:43:26');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `admin_users` VALUES (1, 'admin@admin.cn', 'admin', '$2y$10$cLxXb1NYGK2nY7PoyWnmyu0bBgnu8GDNbsfO1XxT6TnajKMRocr.O', '十年之约项目组', NULL, 'llzMo7dNGLhKQmJEJuwNXgeXxFDPpQPbLhqineEh2c2hsCW7e7hgv3350zgS', '2019-11-25 00:06:57', '2020-08-19 03:33:00');
COMMIT;
...
CREATE TABLE `blog` (
  ...
  `created_at` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1601 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT COMMENT='博客表';
